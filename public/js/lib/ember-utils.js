...
var DynamicSelectView = StaticSelectView.StaticSelectView.extend({
  ...
  }.property("columnData.form.dataPath", "columnData.form.dataRegPath"),
  ...
  selectOptions : function() {
    var
    columnData = this.get("columnData.form"), data = [], opts = [],
    ...
    if(data) {
      data.forEach(function(item) {
        ...
        opts.push(Ember.Object.create({ val : val, label : label }));
      }, this);
    }
